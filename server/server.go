...
var serverCmd = kingpin.Command("server", "Run an IFPS-backed registry")

var gw = serverCmd.Flag("gateway", "IPFS gateway. It must be reachable by pulling clients").
	Envar("IPFS_GATEWAY").
	Default("http://127.0.0.1:8080").
	String()

var addr = serverCmd.Flag("addr", "Listen address. ").
	Default(":5000").
	String()
